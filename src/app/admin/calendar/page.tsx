...
import WeeklyCalendarView from '@/components/admin/weekly-calendar-view';
                ...
                {appointmentsForSelectedDay.length > 0 ? (
                  appointmentsForSelectedDay.map(app => (
                    <div key={app.id} className="flex items-center justify-between p-4 rounded-lg bg-muted/50 border">
                      <div>
                        <p className="font-bold text-lg">{format(parse(app.time, 'HH:mm:ss', new Date()), 'p', { locale: es })}</p>
